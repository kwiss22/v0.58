...
export const SEARCH_SPEC_ANCHOR_ITEMS: SearchSpecAnchorItem[] = [
  ...
  { id: 'spec-search-biz-flow', label: '회원전용 — 2. 검색·목록 이어쓰기', role: 'member' },
  { id: 'spec-search-biz-cards', label: '회원전용 — 3. 카드 클릭 뒷장면', role: 'member' },
  { id: 'spec-search-biz-after-login', label: '회원전용 — 4. 로그인 뒤 편의', role: 'member' },
  { id: 'spec-search-biz-verify', label: '회원전용 — 5. 검증', role: 'member' },
  { id: 'spec-search-biz-refs', label: '회원전용 — 6. 참조 문서', role: 'member' },
];
