import svgPaths from "./svg-pawun9u3co";
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p300f1e80} fill="var(--fill-0, #F0B100)" id="Vector" stroke="var(--stroke-0, #F0B100)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Container40() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[771.9px] items-start left-0 pb-0 pt-[16px] px-[16px] top-[-107.2px] w-[1178.4px]" data-name="Container">
      <Container />
      <Container39 />
    </div>
  );
...
function Container43() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[16px] h-[180px] items-start left-0 pb-[0.8px] pt-[16px] px-[16px] top-0 w-[1178.4px]" data-name="Container">
...
function DoctorSearchPage() {
  return (
    <div className="bg-[#f9fafb] h-[664.8px] overflow-clip relative shrink-0 w-full" data-name="DoctorSearchPage">
      <Container40 />
      <Container43 />
    </div>
  );
